...
class Member extends Controller
{
    ...
    public function insert()
    {
        ...
        if (!$names = $arr['names']) {
            ...
            if ($res) {
                echo "<script>alert('添加成功!');location.href='index.php?c=Member&a=member_list'</script>";
            } else {
                echo "<script>alert('添加失败!');location.href='index.php?c=Member&a=member_add'</script>";
            }
        } else {
            echo "<script>alert('用户已存在!');location.href='index.php?c=Member&a=member_add'</script>";
        }
    }
    //删除的会员
    ...
    public function delete()
    {
        ...
        if ($sql) {
            echo "<script>alert('删除成功!');location.href='index.php?c=Member&a=member_del'</script>";
        } else {
            echo "<script>alert('删除失败!');location.href='index.php?c=Member&a=member_del'</script>";
        }
    }
    //等级管理
