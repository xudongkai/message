...
class Picture extends Controller
{
    ...
    public function delete()
    {
        ...
        $sql = $pdo->delete('image',"`id`='$id'");
         if ($sql) {
            echo "<script>alert('删除成功!');location.href='index.php?c=Picture&a=picture_list'</script>";
        }else{
            echo "<script>alert('删除失败!');location.href='index.php?c=Picture&a=picture_list'</script>";
        }
    }
    public function up(){
        $id = $_GET['id'];
    ...
    public function update()
    {
        ...
        // var_dump($sql);die;
        if ($sql) {
            echo "<script>alert('修改成功!');location.href='index.php?c=Picture&a=picture_list'</script>";
        }else{
            echo "<script>alert('修改失败!');location.href='index.php?c=Picture&a=up'</script>";
        }
    }
}