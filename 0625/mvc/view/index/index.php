...
<header class="header-web">
  <nav>
   <a href="index.php?c=user&a=index" class="logo" title="柚段子" rel="home"><img src="./Public/home/index_files/logo.png" alt="柚段子Logo"></a>
   <form method="get" class="search" action="index.php?c=user&a=seek">
      <input class="text" type="text" name="s" placeholder="Search" value="">   
    </form>
    <ul class="nav-list">
        <li id="menu-item-1296" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-1296" style="width:95px;"><a href="index.php?c=admin\index&a=index">后台登录</a></li>
...
<div class="swiper-container autoImg swiper-container-horizontal">
    <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-1600px, 0px, 0px);">
        ...
        <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="<?php echo $v['id'] ?>" style="width: 800px;">  
            
            <a href="index.php?a=regards" target="_blank">
                <img src="<img src='<?php echo $v['img'] ?>' id='<?php echo $v['id'] ?>' alt="">" alt="">
            </a>
           
        </div>
         <?php } ?>
       <!--  <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="0" style="width: 800px;"> 
            <a href="http://www.yzipi.com/133.htm" target="_blank">
                <img src="./Public/home/index_files/huan1.png" 　alt="">
            </a>
        </div> -->
      <!--   <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="1" style="width: 800px;">  
            <a href="http://www.yzipi.com/388.htm" target="_blank">
                <img src="./Public/index_files/huan2.png" alt="">
            </a>
        </div> -->
        <!-- <div class="swiper-slide swiper-slide-duplicate swiper-slide-next" data-swiper-slide-index="0" style="width: 800px;"> 
            <a href="http://www.yzipi.com/133.htm" target="_blank">
                <img src="./Public/home/index_files/huan1.png" 　alt="">
            </a>
        </div> -->
...
var swiper = new Swiper('.hmFocus .swiper-container', {
   ...
   <section class="list">
       <span class="titleimg"> <a href="index.php?c=user&a=details&id=<?php echo $v['id'] ?>" target="_blank">
  <img width="1000" height="556" src="./Public/home/index_files/lo-1000x556.jpg" class="attachment-thumbnail size-thumbnail wp-post-image" alt="" srcset="http://www.yzipi.com/wp-content/uploads/2018/03/lo-1000x556.jpg 1000w, http://www.yzipi.com/wp-content/uploads/2018/03/lo-768x427.jpg 768w" sizes="(max-width: 1000px) 100vw, 1000px">  </a> </span>
    
  <div class=" mecc">
     
    <h2 class="mecctitle">
    <a href="index.php?c=user&a=details&id=<?php echo $v['id'] ?>" target="_blank" id="<?php echo $v['id'] ?>">
    <?php echo $v['title'] ?></a> </h2>
    <time><?php echo $v['start'] ?></time>
  </div>
