    ...
    <div class="handling_style" id="order_hand">
        <div id="scrollsidebar" class="left_Treeview">
            ...
            <div class="widget-box side_content" >
                ...
                <div class="side_list"><div class="widget-header header-color-green2"><h4 class="lighter smaller">轮播图操作</h4></div>
                    <div class="widget-body">
                        <ul class="b_P_Sort_list">
                            <li><i class="orange  fa fa-reorder"></i><a href="#">全部轮播图(235)</a></li>
        ...
        <div class="order_list_style" id="order_list_style">
            <div class="search_style">
                ...
                <ul class="search_content clearfix">
                    <li><label class="l_f">轮播图名称</label><input name="" type="text"  class="text_add" placeholder="输入轮播图名称"  style=" width:250px"/></li>
            ...
            <div class="Orderform_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tr>
                        ...
                        <th width="320px">轮播图ID</th>
                        <th width="300px">轮播图图片</th>
...
<!--                                <img src="../web/products/p_1.jpg"  title="产品名称"/>-->
<!--                            </a>-->
<!--                            <i class="fa fa-plus"></i>-->
<!--                            <a href="#" class="product_Display">-->
<!--                                <img src="../web/products/p_2.jpg"  title="产品名称"/>-->
<!--                            </a>-->
<!--                        </td>-->
<!--                        <td>456.5</td>-->
<!--                        <td>2016-7-5</td>-->
