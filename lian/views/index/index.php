...
<head>
    ...
    <!-- <![endif]-->
    <!--[if IE]>
     <script type="text/javascript">window.jQuery || document.write("<script src='../web/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
    <![endif]-->
    <script type="text/javascript">
        if("ontouchend" in document) document.write("<script src='../web/assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
    </script>
    <script src="../web/assets/js/bootstrap.min.js"></script>
    <script src="../web/assets/js/typeahead-bs2.min.js"></script>
    <!--[if lte IE 8]>
      <script src="../web/assets/js/excanvas.min.js"></script>
    <![endif]-->
    ...
    <script src="../web/js/jquery.nicescroll.js" type="text/javascript"></script>
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="#" class="navbar-brand">
                <small>
                    <img src="../web/images/logo.png" width="470px">
                </small>
            </a><!-- /.brand -->
        </div><!-- /.navbar-header -->
...
<!--                    <li class="home"><a href="javascript:void(0)" name="home.html" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>-->
                    <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 分类管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a  href="index.php?r=ify/ify" name="Products_List.html"  title="分类添加" class="iframeurl"><i class="icon-double-angle-right"></i>分类添加</a></li>
<!--                            <li class="home"><a  href="index.php?r=ify/del" name="Brand_Manage.html" title="分类删除"  class="iframeurl"><i class="icon-double-angle-right"></i>分类删除</a></li>-->
                            <li class="home"><a  href="index.php?r=ify/show" name="Brand_Manage.html" title="分类展示"  class="iframeurl"><i class="icon-double-angle-right"></i>分类展示</a></li>

                        </ul>
                    </li>
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text"> 轮播图管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="index.php?r=img/img" name="advertising.html" title="轮播图添加" class="iframeurl"><i class="icon-double-angle-right"></i>轮播图添加</a></li>
<!--                            <li class="home"><a href="index.php?r=ify/del" name="Sort_ads.html" title="轮播图删除"  class="iframeurl"><i class="icon-double-angle-right"></i>轮播图删除</a></li>-->
                            <li class="home"><a href="index.php?r=img/show" name="Sort_ads.html" title="轮播图展示"  class="iframeurl"><i class="icon-double-angle-right"></i>轮播图展示</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-credit-card"></i><span class="menu-text"> 商品管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="index.php?r=good/good" name="Cover_management.html" title="商品添加" class="iframeurl"><i class="icon-double-angle-right"></i>商品添加</a></li>
<!--                            <li class="home"><a href="index.php?r=good/del" name="payment_method.html" title="商品删除" class="iframeurl"><i class="icon-double-angle-right"></i>商品删除</a></li>-->
                            <li class="home"><a href="index.php?r=good/show" name="Payment_Configure.html" title="商品展示" class="iframeurl"><i class="icon-double-angle-right"></i>商品展示</a></li>
                        </ul>
                    </li>
