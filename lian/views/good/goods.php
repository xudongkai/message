...
<div class="margin clearfix">
    <div class="article_style">
        <div class="add_content" id="form-article-add">
            ...
            <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data'],'action' => 'index.php?r=good/goodadd']) ?>
            <ul>
                <li class="clearfix Mandatory">
                    <span class="formControls col-10"><?= $form->field($model, 'gname')->textInput() ?></span>
                </li>
                <li>
